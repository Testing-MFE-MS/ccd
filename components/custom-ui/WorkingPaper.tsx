    ...
    <div className="flex-1 -mt-14 overflow-auto">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Customer check and verification form
        </p>
      </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Import CSV file to import customer information
                    </p>
                  </div>
                </div>
                <Button
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            >
              ...
              <AccordionContent className="pb-6 pt-2">
                <Card className="">
                  <CardHeader>
                    <CardTitle className="text-lg">
                      ទម្រង់ព័ត៌មានអតិថិជនសម្រាប់ការត្រួតពិនិត្យ
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <div className="space-y-2">
                        ...
                        <div className="flex">
                          <Input id="cif" className="rounded-r-none" />
                          <Button
                            variant="outline"
                            size="icon"
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="id-user" defaultValue="02311" />
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <Input id="branch" defaultValue="KTL" />
                      </div>
                ...
                <div
                  className=""
                  style={{
                    marginTop: "1.5rem", // mt-8
                    display: "grid", // grid
                    gap: "1.5rem", // gap-6 (24px)
                    gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))",
                    // behaves like: 1 column on mobile, 2 columns on large screens
                  }}
                >
                  <Card>
                    <CardHeader>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <RadioGroupItem
                              value="post-disbursement"
                              id="post-disbursement"
                              className="w-5 h-5"
                            />
                            <Label
                              htmlFor="post-disbursement"
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <RadioGroupItem
                              value="facility-review"
                              id="facility-review"
                              className="w-5 h-5"
                            />
                            <Label
                              htmlFor="facility-review"
                              className="text-base font-medium cursor-pointer"
                            >
                              Facility Review
                            </Label>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <Checkbox
                              id="check-loan-clickloan"
                              className="w-5 h-5"
                            />
                            <Label
                              htmlFor="check-loan-clickloan"
                              className="text-base font-medium cursor-pointer"
                            >
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <Checkbox
                              id="purely-precautionary"
                              className="w-5 h-5"
                            />
                            <Label
                              htmlFor="purely-precautionary"
                              className="text-base font-medium cursor-pointer"
                            >
                      ...
                      <Table>
                        <TableHeader>
                          <TableRow>
                            ...
                            <TableHead className="w-16 hidden xl:table-cell">
                              T...
                            </TableHead>
                          </TableRow>
                        </TableHeader>
            ...
            >
              <AccordionTrigger className="hover:no-underline py-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Report and track issues found during checks
                    </p>
                  </div>
                </div>
              </AccordionTrigger>
              <AccordionContent className="pt-6 pb-6">
                ...
                <div className="bg-primary text-white rounded-lg px-6 py-4 mb-6 flex items-center gap-8">
                  <div className="flex items-center gap-2">
                    <span className="text-white/80">No:</span>
                    <span className="text-secondary font-semibold">67</span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <CardContent className="pt-6 bg-gray-50">
                      ...
                      >
                        <div className="space-y-2">
                          ...
                          <Select defaultValue="ld256000003">
                            ...
                            <SelectContent>
                              <SelectItem value="ld256000003">
                                LD256000003
                              </SelectItem>
                              <SelectItem value="ld256000004">
                                LD256000004
                              </SelectItem>
                              <SelectItem value="ld256000005">
                                LD256000005
                              </SelectItem>
                            </SelectContent>
                          </Select>
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          ...
                          <Select>
                            <SelectTrigger
                              id="key-risk-indicator-2"
                              className="bg-white"
                            >
                              <SelectValue placeholder="Select indicator" />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="payment-delay">
                                Payment Delay
                              </SelectItem>
                              ...
                              <SelectItem value="business-decline">
                                Business Decline
                              </SelectItem>
                            </SelectContent>
                          </Select>
                        ...
                        <div className="space-y-2">
                          ...
                          <Select defaultValue="none">
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="purely-precautionary">
                                Purely Precautionary
                              </SelectItem>
                              <SelectItem value="watch-list">
                                Watch List
                              </SelectItem>
                      ...
                      >
                        <div
                          ...
                          style={{
                            ...
                            border: "1px solid #e5e7eb", // border (gray-200 default)
                            padding: "1.5rem", // p-6
                            marginBottom: "1.5rem", // mb-6
                          }}
                        >
                          ...
                          >
                            <div className="flex items-center space-x-3">
                              <RadioGroupItem
                                value="no-action"
                                id="no-action-2"
                                className="w-4 h-4 border-secondary text-secondary"
                              />
                              <Label
                                htmlFor="no-action-2"
              ...
              <AccordionTrigger className="hover:no-underline py-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Report and track home visit activities
                    </p>
                  </div>
                </div>
              </AccordionTrigger>
              <AccordionContent className="pt-6 pb-6">
                ...
                >
                  ...
                  <Card className="border-0 shadow-sm">
                    ...
                    >
                      <CardTitle className="text-base font-medium flex items-center gap-2 text-secondary">
                    ...
                    <CardContent className="pt-6 space-y-4">
                      ...
                      >
                        <div className="space-y-2">
                          <Label htmlFor="risk-category-ext">
                            Risk Category
                          </Label>
                          <Select defaultValue="LD256000003">
                  ...
                  <Card className="border-0 shadow-sm">
                    ...
                    <CardContent className="pt-6 space-y-4">
                      ...
                      <div className="flex items-center justify-between mt-6">
                        ...
                        <Button className="bg-primary hover:bg-primary/40 text-white h-9 px-4">
            ...
            <AccordionItem
              ...
              className="border border-border rounded-lg bg-white px-8 data-[state=open]:shadow-sm mt-4"
            >
              <AccordionTrigger
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Generate and manage authorized reports
                    </p>
                  </div>
                </div>
              </AccordionTrigger>
              <AccordionContent className="pt-6 pb-6">
                <div
                  ...
                  style={{
                    ...
                    margin: "1.5rem",
                    // 1 column on small screens, left column 320px on large screens
                  }}
                >
                      ...
                      <CardContent className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <Select defaultValue="2025-07-30">
                            ...
                            <SelectContent>
                              <SelectItem value="2025-07-30">
                                30-Jul-2025
                              </SelectItem>
                              <SelectItem value="2025-07-29">
                                29-Jul-2025
                              </SelectItem>
                              <SelectItem value="2025-07-28">
                                28-Jul-2025
                              </SelectItem>
                            </SelectContent>
                          </Select>
                  ...
                  <Card className="border border-border" style={{marginRight:"1.5rem"}}>
                    <CardHeader className="pb-4">
